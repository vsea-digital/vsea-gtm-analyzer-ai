...
def build_gtm_instruction(market: str, industry: str) -> str:
    return (
        ...
        "ENUM FIELDS — MUST use these exact values (case-sensitive):\n"
        '- verdict: "Strong Go" | "Conditional Go" | "Proceed with Caution" | "No Go"\n'
        '- competitors[i].threat: "High" | "Medium" | "Low"\n'
        '- regulatory[i].level: "critical" | "medium" | "low"\n'
        "- keyStats is a list of {label, value} objects (label is the metric name, value is the number/figure)\n\n"
        "Return this EXACT structure:\n"
        '{"companyName":"","product":"","gtmScore":0,"structuralBlocker":false,"blockerExplanation":"","verdict":"","verdictReason":"","summary":"","scoreBreakdown":[{"dimension":"Market Size & Tailwind","score":0,"max":20,"note":"","blocker":false},{"dimension":"Regulatory Feasibility","score":0,"max":20,"note":"","blocker":false},{"dimension":"Competitive Intensity","score":0,"max":15,"note":"","blocker":false},{"dimension":"Entry Barrier Realism","score":0,"max":15,"note":"","blocker":false},{"dimension":"Timing Alignment","score":0,"max":15,"note":"","blocker":false},{"dimension":"GTM Execution Clarity","score":0,"max":10,"note":"","blocker":false},{"dimension":"Company-Market Readiness","score":0,"max":5,"note":"","blocker":false}],"marketOpportunity":{"headline":"","narrative":"","keyStats":[{"label":"","value":""},{"label":"","value":""},{"label":"","value":""}]},"marketSizing":{"tam":{"label":"","value":"","pct":0,"note":""},"sam":{"label":"","value":"","pct":0,"note":""},"som":{"label":"","value":"","pct":0,"note":""},"cagr":"","growth":""},"marketAnalysis":{"overview":"","trends":["","",""],"risks":["",""]},"opportunities":[{"title":"","desc":""},{"title":"","desc":""}],"competitors":[{"rank":1,"name":"","hq":"","desc":"","threat":"High","weakness":""},{"rank":2,"name":"","hq":"","desc":"","threat":"Medium","weakness":""},{"rank":3,"name":"","hq":"","desc":"","threat":"Medium","weakness":""}],"regulatory":[{"level":"critical","agency":"","title":"","desc":"","blocker":false},{"level":"medium","agency":"","title":"","desc":"","blocker":false},{"level":"low","agency":"","title":"","desc":"","blocker":false}],"gtmPlan":{"phase1":{"timing":"","title":"","items":["","",""]},"phase2":{"timing":"","title":"","items":["","",""]},"phase3":{"timing":"","title":"","items":["","",""]}}}'
    )
